...
export type Action =
  | { type: typeof actions.SET_INPUT; field: Field; value: string }
  | { type: typeof actions.SET_ERROR; field: keyof Errors; message: string }
  | { type: typeof actions.CLEAR_ERRORS }
  | { type: typeof actions.SET_AGE; age: Age }
  | { type: typeof actions.RESET_AGE };
